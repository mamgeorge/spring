...
public class SeleniumTests {
	...
	/*
		...
		pom.xml: org.seleniumhq.selenium:selenium-java:4.9.0
			org.seleniumhq.selenium:selenium-http-jdk-client:4.5.0 ?
		for hypervisor systems, copy the primary application folders into hard storage
		see: FirefoxOptions, FirefoxDriver
