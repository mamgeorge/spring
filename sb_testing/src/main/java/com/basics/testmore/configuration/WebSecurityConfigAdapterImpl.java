...
public class WebSecurityConfigAdapterImpl extends WebSecurityConfigurerAdapter {
	...
	@Override protected void configure(AuthenticationManagerBuilder AMB) throws Exception {
		//
	...
	// added for actuator; or see application.yml: management.endpoints.web.exposure.include: "*"
//	@Bean public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity SHS) {
//
//		SecurityWebFilterChain SWFC = SHS.authorizeExchange()
