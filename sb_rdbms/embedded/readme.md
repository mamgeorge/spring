...
Notes:
The persistence is case sensitive with objects.
Multilines need MultipleLinesSqlCommandExtractor
The embedded h2 console JDBC URL must be "jdbc:h2:mem:anydbname"
(match "spring.datasource.url: jdbc:h2:mem:anydbname")
