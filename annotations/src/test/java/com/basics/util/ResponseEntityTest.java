...
import static com.basics.util.RestTemplateTest.*;
...
public class ResponseEntityTest {
	...
	@Test
	void test_RE_responseEntity() {

		RestTemplate restTemplate = new RestTemplate();
		ResponseEntity<String> responseEntity = getForEntity_String(restTemplate, HOST_EXT);
		HttpStatusCode httpStatus = responseEntity.getStatusCode();

		String sb = "ResponseEntity" + EOL + String.format("\tgetStatusCode()\t\t %s\n", responseEntity.getStatusCode()) +
				String.format("\tgetHeaders()...\t\t %s\n", responseEntity.getHeaders()) +
				String.format("\tgetBody()......\t\t %s\n", Objects.requireNonNull(
