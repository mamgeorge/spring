...
public class SqliteDialect extends Dialect {
	...
	@Override public IdentityColumnSupport getIdentityColumnSupport() { return new SqliteIdentityColumnSupportImpl(); }
	...
	@Override public String getAddForeignKeyConstraintString(String cn, String[] fk, String t, String[] pk, boolean rpk) { return ""; }
	...
	@Override public String[] getCreateSchemaCommand(String schemaName) { return new String[]{"create schema " + schemaName}; }

	@Override public String[] getDropSchemaCommand(String schemaName) { return new String[]{"drop schema " + schemaName}; }
